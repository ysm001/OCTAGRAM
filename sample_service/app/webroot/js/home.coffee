  ...
  makePages: () ->
    ...
    page6 = {
      ...
      content: 
        ...
        '<div class="learn-program-btn"> <a target="_blank" href="' + tutorialLink + '" class="btn btn-success btn-lg">' + 'プログラムの組み方を学ぶ' + '</a></div>'  +
        '<div class="learn-game-btn"> <a target="_blank" href="' + gameRuleLink + '" class="btn btn-primary btn-lg">' + 'ゲームのルールを学ぶ' + '</a></div>' +
        '</div>' +
        '</div>'
    }
