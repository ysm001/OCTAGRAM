...
var ActionTip, BranchTip, EmptyTip, NopTip, ReturnTip, SingleTransitionTip, StartTip, StopTip, SubroutineTip, ThinkTip, Tip, WallTip,
...
SubroutineTip = (function(_super) {
  __extends(SubroutineTip, _super);

  function SubroutineTip(next, subroutine) {
    this.subroutine = subroutine;
    SubroutineTip.__super__.constructor.call(this, next);
  }

  SubroutineTip.prototype.clone = function() {
    return this.copy(new SubroutineTip(this.getNext()));
  };

  return SubroutineTip;
