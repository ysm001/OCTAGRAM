...
var BranchTransitionCodeTip, CodeTip, JumpTransitionCodeTip, SingleTransitionCodeTip, SingleTransitionSubroutineCodeTip,
...
SingleTransitionSubroutineCodeTip = (function(_super) {
  __extends(SingleTransitionSubroutineCodeTip, _super);

  function SingleTransitionSubroutineCodeTip(code) {
    SingleTransitionSubroutineCodeTip.__super__.constructor.call(this, code);
  }

  SingleTransitionSubroutineCodeTip.prototype.clone = function() {
    return this.copy(new SingleTransitionSubroutineCodeTip(this.code.clone()));
  };

  return SingleTransitionSubroutineCodeTip;

})(SingleTransitionCodeTip);
