generateTestCode = () ->
    ...
    Game.instance.vpl.currentVM.cpu.putBranchTip(4,0,Direction.leftDown,Direction.rightDown,searchLeftTip)
    Game.instance.vpl.currentVM.cpu.putBranchTip(3,1,Direction.leftDown,Direction.rightDown,currentLeftTip)
    Game.instance.vpl.currentVM.cpu.putBranchTip(2,2,Direction.leftDown,Direction.rightDown,holdTip)
    Game.instance.vpl.currentVM.cpu.putTip(4, 2, Direction.down, left1Tip)
    Game.instance.vpl.currentVM.cpu.putTip(3, 3, Direction.right, pickupNormalTip)
    Game.instance.vpl.currentVM.cpu.putSingleTip(4, 3,returnTip4)
    Game.instance.vpl.currentVM.cpu.putTip(1, 3, Direction.down, shotNormalTip)
    Game.instance.vpl.currentVM.cpu.putSingleTip(1, 4,returnTip5)

    Game.instance.vpl.currentVM.cpu.putBranchTip(5,1,Direction.right,Direction.down,random1Tip)
    Game.instance.vpl.currentVM.cpu.putBranchTip(5,2,Direction.right,Direction.down,random2Tip)
    Game.instance.vpl.currentVM.cpu.putBranchTip(5,3,Direction.right,Direction.down,random3Tip)
    Game.instance.vpl.currentVM.cpu.putBranchTip(5,4,Direction.right,Direction.down,random4Tip)

    Game.instance.vpl.currentVM.cpu.putTip(6, 1, Direction.rightDown, left2Tip)
    Game.instance.vpl.currentVM.cpu.putSingleTip(7, 2,returnTip1)
    Game.instance.vpl.currentVM.cpu.putTip(6, 2, Direction.right, leftUpTip)
    Game.instance.vpl.currentVM.cpu.putTip(6, 3, Direction.rightUp, rightUpTip)
    Game.instance.vpl.currentVM.cpu.putTip(6, 4, Direction.right, rightDownTip)
    Game.instance.vpl.currentVM.cpu.putSingleTip(7, 4,returnTip2)
    Game.instance.vpl.currentVM.cpu.putSingleTip(5, 5,returnTip3)
    # 遷移先の無いチップの設定
    # x, y, チップ
