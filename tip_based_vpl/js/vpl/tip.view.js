...
var BranchTransitionCodeTip, CodeTip, Direction, GhostCodeTip, Icon, JumpTransitionCodeTip, SingleTransitionCodeTip,
...
GhostCodeTip = (function(_super) {
  __extends(GhostCodeTip, _super);

  function GhostCodeTip(tip) {
    GhostCodeTip.__super__.constructor.call(this, tip.code);
    tip.copy(this);
    this.sprite.opacity = 0.5;
    if (tip.icon != null) {
      this.icon.opacity = 0.5;
    }
    this.moveTo(tip.x, tip.y);
