...
var ActionInstruction, BranchInstruction, CustomInstructionActionTip, CustomInstructionBranchTip, CustomTipDescriptor, Instruction, InstructionImporter,
...
CustomTipDescriptor = (function() {
  function CustomTipDescriptor(instruction, description, image) {
    this.instruction = instruction;
    this.description = description;
    this.image = image;
  }

  return CustomTipDescriptor;

})();

InstructionImporter = (function() {
  function InstructionImporter() {}

  InstructionImporter["import"] = function(instDescTable) {
    var desc, tip, tipTable, _i, _len;

    tipTable = [];
    for (_i = 0, _len = instDescTable.length; _i < _len; _i++) {
      desc = instDescTable[_i];
      tip = desc.instruction(isinstanceof(ActionInstruction)) ? new CustomInstructionActionTip(desc.instruction) : new CustomInstructionBranchTip(desc.instruction);
