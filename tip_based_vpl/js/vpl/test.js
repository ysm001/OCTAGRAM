...
var executeTestCode, generateTestCode, loadTestCode, saveTestCode, test;
...
generateTestCode = function() {
  ...
  return Game.instance.vpl.currentVM.cpu.putSingleTip(5, 5, returnTip3);
};

executeTestCode = function() {
  return Game.instance.vpl.currentVM.executer.execute();
};

saveTestCode = function() {
  return Game.instance.vpl.currentVM.cpu.save("test");
};

loadTestCode = function() {
  return Game.instance.vpl.currentVM.cpu.load("test");
};
