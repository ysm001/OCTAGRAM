...
var Background, Button, Footer, Header, HpBar, HpEnclose, HpEnclosePart, Map, MsgBox, MsgWindow, NextButton, Plate, PlayerHp, R, RemainingBullet, RemainingBullets, StatusBox, StatusWindow,
...
StatusBox = (function(_super) {
  ...
  function StatusBox(x, y) {
    ...
    this.x = x;
    this.y = y;
    this.scoreLabel = new ScoreLabel(30, 0);
