...
var DualPickupInstruction, DualShotInstruction, GetBulletQueueSize, GetHp, MoveInstruction, MoveLeftDownInstruction, MoveLeftInstruction, MoveLeftUpInstruction, MoveRightDownInstruction, MoveRightInstruction, MoveRightUpInstruction, NormalPickupInstruction, NormalShotInstruction, Pickup, PickupInstruction, RobotInstruction, Searching, ShotInstruction, WidePickupInstruction, WideShotInstruction,
...
MoveInstruction = (function(_super) {
  ...
  function MoveInstruction(robot, direct, frame, instrClass) {
    this.robot = robot;
    this.direct = direct;
    this.frame = frame;
