...
var GetBulletQueueSize, GetHp, HP_STR, HoldBulletBranchInstruction, HoldBulletStr, HpBranchInstruction, MOVE_STR, MoveInstruction, PICKUP_STR, Pickup, PickupInstruction, R, RobotInstruction, SHOT_STR, Searching, ShotInstruction,
...
PickupInstruction = (function(_super) {
  ...
  PickupInstruction.prototype.action = function() {
    ...
    ret = bltQueues[this._id].enqueue(blt);
    if (ret !== false) {
