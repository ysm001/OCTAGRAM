...
var Footer, MsgBox, R, RemainingBulletsGroup, StatusBox,
...
RemainingBulletsGroup = (function(_super) {
  var RemainingBullet, RemainingBullets;
  ...
  */
  ...
  RemainingBullet = (function(_super1) {
    __extends(RemainingBullet, _super1);
  ...
  RemainingBullets = (function(_super1) {
    __extends(RemainingBullets, _super1);
...
StatusBox = (function(_super) {
  ...
  */
  ...
  StatusWindow = (function(_super1) {
    __extends(StatusWindow, _super1);
...
Footer = (function(_super) {
  ...
  function Footer(x, y) {
    ...
    this.addView(new StatusBox(x + MsgBox.WIDTH + 32, 16));
  }
