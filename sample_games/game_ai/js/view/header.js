...
var EnemyHp, Header, HpView, PlayerHp, R,
...
HpView = (function(_super) {
  var HpBar, HpEnclose, HpEnclosePart;
  ...
  */
  ...
  HpBar = (function(_super1) {
    __extends(HpBar, _super1);
    ...
    function HpBar(x, y, resource) {
      ...
      switch (resource) {
        case HpView.GREEN:
          this.image = Game.instance.assets[R.BACKGROUND_IMAGE.HP_GREEN];
          break;
        case HpView.RED:
          this.image = Game.instance.assets[R.BACKGROUND_IMAGE.HP_RED];
      }
    }
  ...
  HpEnclosePart = (function(_super1) {
    __extends(HpEnclosePart, _super1);
  ...
  HpEnclose = (function(_super1) {
    __extends(HpEnclose, _super1);
...
EnemyHp = (function(_super) {
  ...
  function EnemyHp(x, y) {
    EnemyHp.__super__.constructor.call(this, x, y, HpView.RED);
  }
...
PlayerHp = (function(_super) {
  ...
  function PlayerHp(x, y) {
    PlayerHp.__super__.constructor.call(this, x, y, HpView.GREEN);
  }
