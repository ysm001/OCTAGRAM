...
var Background, Button, Footer, Header, HpBar, HpEnclose, HpEnclosePart, Map, MsgBox, MsgWindow, NextButton, Plate, PlayerHp, R, RemainingBullet, RemainingBullets, RemainingBulletsGroup, Spot, StatusBarrier, StatusBarrierGroup, StatusBox, StatusWindow, ViewGroup, ViewSprite,
...
MsgBox = (function(_super) {
  ...
  MsgBox.prototype.initEvent = function(world) {
    var _this = this;
    return world.player.addEventListener('move', function(evt) {
      var player, point;
      player = evt.target;
      point = evt.params;
      if (point !== false) {
