...
var Background, Button, Footer, Header, HpBar, HpEnclose, HpEnclosePart, Map, MsgBox, MsgWindow, NextButton, Plate, PlayerHp, R, RemainingBullet, RemainingBullets, Spot, StatusBarrier, StatusBox, StatusWindow,
...
StatusBox = (function(_super) {
  ...
  function StatusBox(x, y) {
    ...
    this.x = x;
    this.y = y;
    this.statusNormalBarrier = new StatusBarrier(30, 0, 1);
    this.statusWideBarrier = new StatusBarrier(55, 0, 3);
    this.statusDualBarrier = new StatusBarrier(80, 0, 5);
    ...
    this.addChild(this.statusNormalBarrier);
    this.addChild(this.statusWideBarrier);
    this.addChild(this.statusDualBarrier);
