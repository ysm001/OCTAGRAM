...
var Background, Button, Footer, Header, HpBar, HpEnclose, HpEnclosePart, Map, MsgBox, MsgWindow, NextButton, Plate, PlayerHp, R, RemainingBullet, RemainingBullets, RemainingBulletsGroup, Spot, StatusBarrier, StatusBarrierGroup, StatusBox, StatusWindow,
...
StatusBox = (function(_super) {
  ...
  function StatusBox(x, y) {
    ...
    this.x = x;
    this.y = y;
    this.barrier = new StatusBarrierGroup();
    this.remain = new RemainingBulletsGroup();
    this.addChild(this.barrier);
    this.addChild(this.remain);
  }
